...
| [vscode-chat-agent-testing.md](vscode-chat-agent-testing.md) | Authenticated Copilot Chat extension-host E2E rules, launch/auth requirements, and chat participant regression patterns |
